...
export async function POST(req: Request) {
  try {
    ...
    const nutritionistSubtype = body?.nutritionistSubtype
      ? String(body.nutritionistSubtype).trim()
      : null;
    ...
    if (!professional) {
      professional = await prisma.professional.create({
        data: {
          ...
          nutritionistSubtype: nutritionistSubtype || undefined,
          type: "NUTRITIONIST",
      ...
      await prisma.professional.update({
        ...
        data: {
          ...
          nutritionistSubtype:
            nutritionistSubtype || professional.nutritionistSubtype,
        },
      });
    ...
    console.error(
      "POST /api/organization/create_user_in_organization/nutritionist/create error:",
      e
    );
