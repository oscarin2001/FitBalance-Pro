...
type CreateNutritionistFormProps = {
  orgSlug: string;
  redirectPath?: string;
  onSuccess?: () => Promise<void> | void;
};

export default function CreateNutritionistForm({
  orgSlug,
  redirectPath,
  onSuccess,
}: CreateNutritionistFormProps) {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      setFeedback({
        tone: "success",
        text: "Nutricionista creado correctamente",
      });
      if (onSuccess) {
        await onSuccess();
      }
  ...
  return (
    <Card className="border-border/70 shadow-sm">
      <CardHeader className="space-y-1">
        <CardTitle>Nuevo nutricionista</CardTitle>
        <CardDescription>
          Completa los datos base del profesional para generar el acceso y
          sincronizarlo con tu directorio.
        </CardDescription>
      </CardHeader>
      <CardContent>
        <form onSubmit={handleSubmit} className="space-y-5">
          <div className="grid gap-4 sm:grid-cols-2">
            <div className="space-y-1.5">
              <Label htmlFor="nutritionist-first-name">Nombre</Label>
              <Input
            ...
            <div className="space-y-1.5">
              <Label htmlFor="nutritionist-last-name">Apellido</Label>
              <Input
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            <div className="space-y-1.5">
              ...
              <div className="mt-1 flex items-center gap-2">
                <Input
                  ...
                  aria-describedby={
                    defaultDomain ? "nutritionist-email-hint" : undefined
                  }
                />
                {defaultDomain ? (
            ...
            <div className="space-y-1.5">
              <Label htmlFor="nutritionist-phone">Teléfono</Label>
              <Input
          ...
          <div className="flex flex-col gap-2 sm:flex-row sm:items-center">
            <Button type="submit" disabled={disableSubmit}>
              {loading ? "Guardando..." : "Agregar nutricionista"}
            </Button>
            {feedback && (
              <p
                className={`text-sm ${
